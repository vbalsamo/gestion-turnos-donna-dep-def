...
<div id="carouselExampleIndicators" class="carousel slide pause" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="{{ asset('verano.png') }}" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="10000">
      <img src="{{ asset('promocion_navidad.png') }}" class="d-block w-100" alt="...">
    </div>
...
<div class="container inner-seccion my-5 pt-5">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto my-auto">
                <img src="{{ asset('tratamiento_facial_home.jpg') }}" class="mx-auto d-block img-fluid shadow">
            </div>
